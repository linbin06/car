...
<div class="layui-layout layui-layout-admin">
        ...
        <div class="layui-main mag0">
            ...
            <ul class="layui-nav top_menu">
                ...
                <li class="layui-nav-item" id="userInfo">
                    <a href="javascript:">
                        <img src="${pageContext.request.contextPath}/resources/images/face.jpg"
                    ...
                    <dl class="layui-nav-child">
                        ...
                        <dd><a href="${pageContext.request.contextPath}/login/toLogin.action" class="signOut"><i
    ...
    <div class="layui-side layui-bg-black">
        <div class="user-photo">
            <a class="img" title="我的头像"><img src="${pageContext.request.contextPath}/resources/images/face.jpg"
                                                 class="userAvatar"></a>
        ...
        <div class="navBar layui-side-scroll" id="navBar">
            <ul class="layui-nav layui-nav-tree">
                ...
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd>
                            <a data-url="../bus/toRentCarManager.action">
                                <i class="layui-icon" data-icon="">
                                    <cite>汽车出租</cite>
                                </i>
                            </a>
                        ...
                        <dd>
                            <a data-url="../bus/toRentManager.action">
                                <i class="layui-icon" data-icon="">
                                    <cite>出租单管理</cite>
                                </i>
                            </a>
                        ...
                        <dd>
                            <a data-url="../bus/toCheckCarManager.action">
                                <i class="layui-icon" data-icon="">
                                    <cite>汽车入库</cite>
                                </i>
                            </a>
                        ...
                        <dd>
                            <a data-url="../bus/toCheckManager.action">
                                <i class="layui-icon" data-icon="">
                                    <cite>检查单管理</cite>
                                </i>
                            </a>
        ...
        <div class="layui-tab mag0" lay-filter="bodyTab" id="top_tabs_box">
            ...
            <ul class="layui-nav closeBox">
                <li class="layui-nav-item">
                    ...
                    <dl class="layui-nav-child">
                        <dd><a href="javascript:" class="refresh refreshThis"><i class="layui-icon">&#xe669;</i> 刷新当前</a>
                        </dd>
