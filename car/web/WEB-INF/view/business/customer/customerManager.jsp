    ...
    <form class="layui-form" lay-filter="dataFrm" id="dataFrm">
        <div class="layui-form-item">
            ...
            <div class="layui-inline">
                <label class="layui-form-label">身份证号:</label>
                <div class="layui-input-inline">
                    <input type="text" name="identity" lay-verify="required" placeholder="请输入客户身份证号"
                           autocomplete="off"
                           class="layui-input">
                </div>
            </div>
    ...
    layui.use(['jquery', 'layer', 'form', 'table'], function () {
        ...
        tableIns = table.render({
            ...
            cols: [[ //表头设置
                ...
                {field: "customerName", title: "客户姓名", align: "center", width: "125"},
        ...
        table.on("tool(customerTable)", function (obj) {
            ...
            var data = obj.data;
            if (obj.event === 'del') {
                layer.confirm("您确认删除[" + data.customerName + "]这个用户信息吗?", function (index) {
                    //如果用户点击确认删除
